package ru.nsu.ccfit.mandarkhanov.view.text;

import ru.nsu.ccfit.mandarkhanov.model.MineField;
import ru.nsu.ccfit.mandarkhanov.model.PairInt;
import ru.nsu.ccfit.mandarkhanov.view.View;
...
public class TextView implements View {
    ...
    public void printHighScores() {
        try {
            Scanner scanner = new Scanner(new FileInputStream("src/ru/nsu/ccfit/mandarkhanov/resoruses/HighScores.txt"));
            for (int i = 0; i < 11; i++) {
